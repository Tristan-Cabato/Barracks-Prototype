...
export default function InventoryPage() {
  return (
    <div className="relative flex min-h-[calc(100vh-3.5rem)] items-center justify-center overflow-hidden bg-background">
      ...
      >
        <Wrench className="mx-auto mb-6 h-16 w-16 text-amber-500/60 dark:text-amber-400/60" />
        ...
        <p className="mt-6 max-w-xs text-sm leading-relaxed text-muted-foreground">
          This module is being built. Check back soon for inventory tracking and management.
        </p>
      </div>
    </div>
  )
